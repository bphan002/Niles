...
class ProductShow extends React.Component {
  ...
  render() {
    ...
    if (isLoaded) {
      ...
      const totalStars = Object.values(this.props.reviews).reduce(
      ...
      return (
        <div className='product-show-container'>
          ...
          <div className="product-info">
            ...
            <p>About this item</p>
            <p>
              {this.props.product.bullet.map((bullet, idx) => (
              ...
              {Object.values(this.props.reviews ?? {}).map((review, idx) => {
                return (
                  <div className="avatar-container" key={idx}>
                    ...
                    <p className="date">
                      Reviewed in the United States on {month} {dayNum}, {year}
                    </p>
                    <p>{review.comment}</p>
                    <div>
                      {review.user_id ? (
